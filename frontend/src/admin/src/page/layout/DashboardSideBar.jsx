...
const DashboardSideBar = ({ active }) => {
    return (
        <div className="w-[250px] h-[100vh] bg-pink-200 text-black shadow-md sticky top-0 left-0 z-10">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/total_vendors" className="w-full flex items-center gap-2">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/inventory" className="w-full flex items-center gap-2">
                    <CiMoneyBill
                        size={30}
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/total_customers" className="w-full flex items-center gap-2">
